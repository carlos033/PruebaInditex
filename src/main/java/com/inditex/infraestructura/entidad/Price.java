...
public class Price implements Serializable {
	...
	@NotNull
	@Schema(name = "price_list", description = " Identificador de la tarifa de precios " + "aplicable", example = "2")
	...
	@Schema(name = "startDate", description = " Fecha en la que se empieza a aplicar aplicacion de la tarifa", example = "2023-05-01T14:30:00Z")
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss'Z'")
	private OffsetDateTime startDate;

	@Schema(name = "endDate", description = " Fecha en la que se finaliza la aplicacion de la tarifa", example = "2023-05-01T14:30:00")
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss'Z'")
